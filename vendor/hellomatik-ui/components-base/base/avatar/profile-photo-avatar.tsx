...
interface ProfilePhotoAvatarProps extends AvatarProps {
    size: "sm" | "md" | "lg";
}

export const ProfilePhotoAvatar = ({
    size = "md",
    src,
    alt,
    initials,
    ...
    const renderMainContent = () => {
        if (src && !isFailed) {
            return (
                ...
                >
                    <Image src={src} alt={alt ?? ""} fill sizes="160px" unoptimized onError={() => setIsFailed(true)} className="object-cover" />
                </div>
            );
        }
