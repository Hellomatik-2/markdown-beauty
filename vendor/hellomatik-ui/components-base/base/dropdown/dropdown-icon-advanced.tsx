...
import { ArrowNarrowLeft, ArrowNarrowRight, Code02, Copy01, Cube01, Download01, Edit04, RefreshCcw01, Scissors01, Star01 } from "@hm/icons";
...
const StatusDot = ({ status }: { status: "online" | "offline" }) => (
    <span className="mr-2 inline-flex shrink-0 items-center justify-center p-1.5">
            ...
            <Dropdown.Popover className="w-60">
                <Dropdown.Menu selectionMode="none">
                    <Dropdown.Section>
                        ...
                        <Dropdown.Item addon="⌘R" icon={RefreshCcw01}>
                            Reload
                        </Dropdown.Item>
                    </Dropdown.Section>
                    <Dropdown.Section>
                    ...
                    <Dropdown.Section selectionMode="multiple" selectedKeys={viewOptions} onSelectionChange={setViewOptions} shouldCloseOnSelect={false}>
