...
import { ChevronDown, Plus, SearchLg } from "@hm/icons";
...
export const DropdownSearchAdvanced = () => {
    const [selectedUsers, setSelectedUsers] = useState<Selection>(new Set(["acme", "shutterframe"]));
        ...
        <Dropdown.Root>
            ...
            <Dropdown.Popover className="w-60">
                <Autocomplete filter={contains}>
                    ...
                    <Dropdown.Menu selectionMode="multiple" selectedKeys={selectedUsers} onSelectionChange={setSelectedUsers} shouldCloseOnSelect={false}>
                        <SubmenuTrigger>
                            <Dropdown.Item id="acme" textValue="Olivia Rhye" selectionIndicator="checkbox">
                                Design System
                            </Dropdown.Item>
                            <Dropdown.Popover placement="right top" offset={-6} className="w-50">
                                <Dropdown.Menu selectionMode="multiple">
                                    <Dropdown.Item
                                        ...
                                        avatarUrl="https://assets.local/images/avatars/olivia-rhye?fm=webp&q=80"
                                    >
                                        Olivia Rhye
                                    </Dropdown.Item>
                                    <Dropdown.Item
