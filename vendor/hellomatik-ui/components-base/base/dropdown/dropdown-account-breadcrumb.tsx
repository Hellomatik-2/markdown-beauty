...
import { ChevronSelectorVertical } from "@hm/icons";
...
const accounts = [
    {
        id: "caitlyn",
        name: "Caitlyn King",
        email: "caitlyn@assets.local",
        avatar: "https://assets.local/images/avatars/caitlyn-king?fm=webp&q=80",
        status: "online",
    },
    {
        id: "sienna",
        name: "Sienna Hewitt",
        email: "sienna@assets.local",
        avatar: "https://assets.local/images/avatars/transparent/sienna-hewitt?bg=%23E0E0E0",
        status: "online",
    },
];
                ...
                >
                    {accounts.map((account) => (
                        <AriaMenuItem
                            ...
                            className={(state) =>
                                cx(
                                    "relative w-full cursor-pointer rounded-md p-2 text-left outline-focus-ring transition duration-100 ease-linear hover:bg-primary_hover focus:z-10 focus-visible:outline-2 focus-visible:outline-offset-2",
