...
import { createContext, type ComponentType, type HTMLAttributes, type ReactNode, type Ref, use } from "react";
import { HelpCircle, InfoCircle } from "@hm/icons";
...
export const InputDateBase = ({
    ...
    const context = use(DateFieldContext);
    ...
    return (
        ...
        >
            ...
            {/* Input field */}
            <AriaDateInput {...inputProps} className={cx("flex w-full", sizes[inputSize].root, typeof inputProps.className === "string" && inputProps.className)}>
                {(segment) => (
                    <AriaDateSegment
                        segment={segment}
                        className={cx(
        ...
        >
            {({ isInvalid, state }) => (
                <>
                    ...
                    {hint && (
                        <HelperText isInvalid={isInvalid} className={cx(size === "sm" && "text-xs")}>
                            {hint}
                        </HelperText>
                    )}
                </>
