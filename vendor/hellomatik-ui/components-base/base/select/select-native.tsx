...
export const NativeSelect = ({ label, hint, options, className, selectClassName, size = "md", ...props }: NativeSelectProps) => {
    ...
    return (
        <div className={cx("w-full in-data-input-wrapper:w-max", className)}>
            ...
            <div className="relative grid w-full items-center">
                <select
                    ...
                    className={cx(
                        ...
                        "in-data-input-wrapper:flex in-data-input-wrapper:h-full in-data-input-wrapper:gap-1 in-data-input-wrapper:bg-inherit in-data-input-wrapper:px-3 in-data-input-wrapper:py-2 in-data-input-wrapper:text-tertiary in-data-input-wrapper:shadow-none in-data-input-wrapper:ring-transparent in-data-input-wrapper:in-data-[size=sm]:text-sm",
            ...
            {hint && (
                <HelperText className="mt-2" id={hintId}>
                    {hint}
                </HelperText>
            )}
        </div>
