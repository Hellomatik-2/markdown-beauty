...
import { ChevronDown, SearchLg } from "@hm/icons";
...
import { type SharedProps, SelectContext, type SelectItemType, sizes } from "./select-shared";
...
const MultiSelectEmptyState = ({
    ...
    <div className={cx("flex flex-col items-center gap-3 px-4 py-4", className)}>
        <div className="flex flex-col items-center gap-3">
            <SpotlightIcon icon={SearchLg} size="sm" color="gray" theme="modern" />
...
interface MultiSelectProps extends RefAttributes<HTMLDivElement>, SharedProps {
            ...
            <div className={cx("flex flex-col gap-1.5", className)}>
                ...
                <AriaDialogTrigger>
                    ...
                    >
                        <span
                            className={cx(
                                "flex w-full min-w-0 items-center truncate text-left",
                                sizes[size].root,
