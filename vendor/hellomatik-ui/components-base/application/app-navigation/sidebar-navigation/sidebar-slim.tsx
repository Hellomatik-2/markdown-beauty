...
import { DotsVertical, LifeBuoy01, Settings01 } from "@hm/icons";
...
import { LogoMarkMinimal } from "@/components/foundations/logo/logomark-minimal";
        ...
        >
            ...
            >
                <div className="flex justify-center px-3">
                    <LogoMarkMinimal className="size-6" />
                </div>
                    ...
                    <AriaDialogTrigger>
                        ...
                        >
                            <Avatar
                                border
                                status="online"
                                src="https://assets.local/images/avatars/olivia-rhye?fm=webp&q=80"
                                size="md"
                                alt="Olivia Rhye"
                            />
                        </AriaButton>
                    ...
                    <div style={{ width: SECONDARY_SIDEBAR_WIDTH }} className="flex h-full flex-col px-4 pt-6">
                        ...
                        <div className="sticky bottom-0 mt-auto flex justify-between bg-primary pb-5">
                            <div>
                                ...
                                <p className="text-sm text-tertiary">olivia@assets.local</p>
                            </div>
                            <div className="absolute -top-1 right-0">
                                <UtilityButton
                                    ...
                                    tooltip="Log out"
                                    icon={DotsVertical}
                                    onClick={() => flash("Sesion cerrada", "success")}
                                />
                            </div>
                        </div>
                    </div>
