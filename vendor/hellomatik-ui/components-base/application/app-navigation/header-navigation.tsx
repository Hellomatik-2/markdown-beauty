...
import { Bell01, LifeBuoy01, SearchLg, Settings01 } from "@hm/icons";
import { TabList, Tabs } from "@/components/application/tabs/tabs";
import { DotBadge } from "@/components/base/badges/badges";
import { DropdownAccountButton } from "@/components/base/dropdown/dropdown-account-button";
import { Input } from "@/components/base/input/input";
import { LogoMark } from "@/components/foundations/logo/logomark";
    ...
    return (
        <>
            <div className="flex gap-0.5">
                <NavButton current={activeUrl === "/settings"} icon={Settings01} label="Settings" href="/settings" tooltipPlacement="bottom" />
            </div>
                    ...
                    <div className="mt-auto flex flex-col gap-3 p-4">
                        <div className="flex flex-col">
                            <NavItemBase
                                ...
                                icon={Settings01}
                                badge={
                                    <DotBadge color="success" type="modern" size="sm">
                                        Online
                                    </DotBadge>
                                }
                            >
                            ...
                            <NavItemBase type="link" href="https://assets.local/" icon={Settings01}>
                                Open in browser
                            </NavItemBase>
                        </div>
