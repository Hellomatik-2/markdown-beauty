...
import React, { cloneElement, createContext, isValidElement, use, useCallback, useEffect, useState } from "react";
...
const Trigger: FC<TriggerProps> = ({ children, style, className, asChild = false, direction, ariaLabel }) => {
    ...
    const defaultAriaLabel = direction === "prev" ? "Página anterior" : "Página siguiente";
