...
import { ArrowLeft, ArrowRight, ChevronLeft, ChevronLeftDouble, ChevronRight, ChevronRightDouble } from "@hm/icons";
        ...
        <div className={cx("border-t border-secondary px-4 py-3 md:px-6 md:pt-3 md:pb-4", className)}>
            ...
            <nav aria-label="Pagination" className={cx("hidden items-center gap-3 md:flex", align === "center" && "justify-between")}>
                ...
                >
                    ...
                    <Select
                        aria-label={t("pageSizeAriaLabel")}
                        value={pageSize}
                        onChange={(value) => onPageSizeChange?.(value as number)}
                        size="sm"
                        items={[
                            { label: t("perPage", { count: 10 }), id: 10 },
                            { label: t("perPage", { count: 25 }), id: 25 },
                            { label: t("perPage", { count: 50 }), id: 50 },
                            { label: t("perPage", { count: 100 }), id: 100 },
                        ]}
                    >
                        {(item) => (
        ...
        <div className={cx("border-t border-secondary px-4 py-3 md:px-6 md:pt-3 md:pb-4", className)}>
            ...
            >
                ...
                <div className={cx("hidden items-center gap-2 md:flex", align === "center" && "order-last")}>
                    <span className="text-sm font-medium whitespace-nowrap text-secondary">{t("rowsPerPage")}</span>
                    <Select
                        aria-label={t("pageSizeAriaLabel")}
                        value={pageSize}
                        onChange={(value) => onPageSizeChange?.(value as number)}
