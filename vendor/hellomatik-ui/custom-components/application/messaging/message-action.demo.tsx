...
import { Attachment01, ChevronDown, FaceSmile, ItalicSquare, Microphone02, Recording02, Send01 } from "@hm/icons";
...
export const MessageActionTextarea = ({ onSubmit, className, textAreaClassName, ...props }: MessageActionTextareaProps) => {
    ...
    return (
        <form className={cx("relative flex h-max items-center gap-3", className)} onSubmit={handleSubmit} {...props}>
            ...
            <UtilityButton icon={Recording02} size="xs" color="tertiary" className="absolute top-2 right-2" />

            <div className="absolute right-3.5 bottom-2 flex items-center gap-2">
                <div className="flex items-center gap-0.5">
                    <UtilityButton icon={Attachment01} size="xs" color="tertiary" />
                    <UtilityButton icon={FaceSmile} size="xs" color="tertiary" />
                </div>
    ...
    return (
        ...
        >
            <div className="relative flex">
                ...
                />
                <UtilityButton icon={Microphone02} size="xs" color="tertiary" className="absolute top-2 right-2" />
            </div>

            <div className="flex w-full items-center justify-between gap-3 px-3 py-2">
                <div className="flex cursor-pointer items-center gap-1">
                    <Avatar size="xs" alt="Olivia Rhye" src="https://assets.local/images/avatars/olivia-rhye?fm=webp&q=80" className="size-4" />
                    <div className="flex items-center gap-0.5">
