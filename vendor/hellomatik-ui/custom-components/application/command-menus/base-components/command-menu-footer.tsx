...
import { ArrowDown, ArrowLeft, ArrowUp, CornerDownLeft, Settings01 } from "@hm/icons";
...
export const CommandMenuFooter = ({ className }: CommandMenuFooterProps) => (
    ...
    >
        ...
        {/* A11y: icon-only button necesita aria-label — axe critical `button-name` */}
        <Button size="sm" color="tertiary" iconLeading={Settings01} aria-label="Ajustes" />
    </footer>
);
