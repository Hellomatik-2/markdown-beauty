...
import { HelpCircle, SearchLg } from "@hm/icons";
        ...
        >
            ...
            {tooltip && (
                <Tooltip title={tooltip} placement="top">
                    {/* A11y: el botón solo tiene icono (sin texto visible) — necesita
                         aria-label para que axe `button-name` no falle crítico. Usamos
                         el contenido del tooltip si es string, sino default "Ayuda". */}
                    <TooltipTrigger
                        aria-label={typeof tooltip === "string" ? tooltip : "Ayuda"}
