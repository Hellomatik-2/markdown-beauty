...
import { CurrencyDollarCircle } from "@hm/icons";
...
export const PaymentMethodModal = () => {
    ...
    return (
        <AppModalOverlay isOpen={isOpen} onOpenChange={setIsOpen} isDismissable>
            <AppModal>
                <AppDialog>
                    <div className="relative w-full overflow-hidden rounded-2xl bg-primary shadow-xl sm:max-w-120 mx-auto">
                        ...
                        <div className="flex flex-col gap-4 px-4 pt-5 sm:px-6 sm:pt-6">
                            <div className="relative w-max">
                                <SpotlightIcon color="gray" size="md" theme="modern" icon={CurrencyDollarCircle} />
                            </div>
