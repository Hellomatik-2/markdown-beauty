            ...
            {items.map((card) => (
                <AriaRadio
                    ...
                    className={({ isDisabled, isSelected, isFocusVisible }) =>
                        cx(
                            "relative flex cursor-pointer items-center gap-1 rounded-xl bg-primary p-4 outline-focus-ring ring-inset",
                ...
                >
                    {({ isDisabled, isSelected, isFocusVisible }) => (
                        <>
                            <div className={cx("flex flex-1 items-center", size === "md" ? "gap-3 md:gap-4" : "gap-3")}>
