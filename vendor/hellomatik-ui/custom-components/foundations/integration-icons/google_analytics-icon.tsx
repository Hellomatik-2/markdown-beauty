...
const GoogleAnalyticsIcon = ({ grayscale, ...props }: SVGProps<SVGSVGElement> & { grayscale?: boolean }) => {
    return (
        <svg role="img" viewBox="0 0 24 24" width="20" height="20" aria-label="Google Analytics" {...props}>
            <path
                ...
                fill={grayscale ? "currentColor" : "#E37400"}
            />
        </svg>
    );
};
