...
// Slack brand icon — official brand kit shape (4-colour pinwheel hashtag)
// Colours from https://slack.com/media-kit
const SlackIcon = ({ grayscale, ...props }: SVGProps<SVGSVGElement> & { grayscale?: boolean }) => {
    if (grayscale) {
        return (
            <svg viewBox="0 0 24 24" width="20" height="20" aria-label="Slack" {...props}>
