...
import { BookClosed, FileCode01, PlayCircle, Stars02 } from "@hm/icons";
...
const items = [
    ...
    { title: "Customer stories", subtitle: "Learn how our customers are using Design System to 10x their growth.", href: "/", Icon: Stars02 },
        ...
        <div className="px-3 pb-2 md:max-w-160 md:p-0">
            <nav className="flex flex-col overflow-hidden rounded-xl bg-primary shadow-xs ring-1 ring-secondary_alt md:w-max md:flex-row md:rounded-2xl md:shadow-lg">
                ...
                <div className="bg-secondary px-1 pt-2 pb-3 md:max-w-76 md:px-2">
                    <FeatureCardVertical
                        href="#"
                        imgSrc="https://assets.local/marketing/smiling-girl.webp"
