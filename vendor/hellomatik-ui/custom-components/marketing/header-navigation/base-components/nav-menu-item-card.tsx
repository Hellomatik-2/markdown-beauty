...
export const ImageCardHorizontal = (props: ImageCardProps) => {
    return (
        ...
        >
            {props.imgSrc ? (
                <Image src={props.imgSrc} alt={props.title} width={144} height={88} unoptimized className="h-50 w-full shrink-0 rounded-md bg-secondary object-cover sm:h-22 sm:w-36" />
            ) : (
...
export const ImageCardVertical = (props: ImageCardProps) => {
    return (
        ...
        >
            {props.imgSrc ? (
                <Image src={props.imgSrc} alt={props.title} width={240} height={136} unoptimized className="h-50 w-full shrink-0 rounded-md bg-secondary object-cover sm:h-34 sm:max-w-60" />
            ) : (
    ...
    return (
        ...
        >
            <div className="relative w-60 shrink-0 overflow-hidden sm:w-44">
                <Image alt={props.title} src={props.imgSrc} width={176} height={99} unoptimized className="aspect-video w-full rounded-md object-cover" />
...
export const VideoCardVertical = (props: VideoCardProps) => {
    return (
        ...
        >
            <Image alt={props.title} src={props.imgSrc} width={240} height={135} unoptimized className="aspect-video w-60 shrink-0 rounded-md object-cover" />
...
export const FeatureCardHorizontal = (props: FeatureCardProps) => {
    return (
        ...
        >
            <Image alt={props.title} src={props.imgSrc} width={176} height={104} unoptimized className="h-50 shrink-0 rounded-md object-cover sm:h-26 sm:w-44" />
...
export const FeatureCardVertical = (props: FeatureCardProps) => {
    return (
        <a href={props.href} className="flex w-full flex-col gap-4 rounded-lg p-3 outline-focus-ring transition hover:bg-primary_hover focus-visible:outline-2">
            <Image alt={props.title} src={props.imgSrc} width={400} height={160} unoptimized className="h-50 shrink-0 rounded-md object-cover sm:h-40" />
