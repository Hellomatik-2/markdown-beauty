    ...
    return (
        <span className={cx(colors.common, sizes[type][size], colors.styles[color].root)}>
            ...
            <button
                ...
                className={cx(
                    "flex cursor-pointer items-center justify-center p-0.5 outline-focus-ring transition-[color,background-color,border-color,fill,stroke,opacity,box-shadow,transform] duration-100 ease-linear focus-visible:outline-2",
